...
public class MeshSphere: MonoBehaviour
{
    ...
    void Generate()
    {
        ...
        for (int y = 0; y <= ySize; y++)
        {
            ...
            {
                vertices[vericesIndex] = new Vector3(x, y);
                //给第一套uv赋值
        ...
        for (int y = 0; y <= ySize; y++)
        {
            for (int x = 0; x <= xSize; x++, vericesIndex++)
            {
                vertices[vericesIndex] = new Vector3(x, y, zSize);
                //给第一套uv赋值
        ...
        for (int z = 0; z <= zSize; z++)
        {
            for (int x = 0; x <= xSize; x++, vericesIndex++)
            {
                vertices[vericesIndex] = new Vector3(x, 0, z);
                //给第一套uv赋值
        ...
        for (int z = 0; z <= zSize; z++)
        {
            for (int x = 0; x <= xSize; x++, vericesIndex++)
            {
                vertices[vericesIndex] = new Vector3(x, ySize, z);
                //给第一套uv赋值
        ...
        for (int y = 0; y <= ySize; y++)
        {
            ...
            {
                vertices[vericesIndex] = new Vector3(0, y, z);
                //给第一套uv赋值
        ...
        for (int y = 0; y <= ySize; y++)
        {
            for (int z = 0; z <= zSize; z++, vericesIndex++)
            {
                vertices[vericesIndex] = new Vector3(xSize, y, z);
                //给第一套uv赋值
